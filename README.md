...
- Tapahtumien muokkaus jälkikäteen — kaikki tiedot samassa näkymässä (✏️)
- Tulevat tapahtumat jaettu välilehtiin: 🎤 Keikat / 🎸 Treenit / 👤 Poissaolot (Keikat oletuksena)
- Päivää klikkaamalla sen tapahtumat näkyvät omassa osiossa välilehtien yläpuolella
